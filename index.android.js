...
class FilteredTable extends Component {
    ...
    updateDataSource(props) {
        ...
        this.setState({dataSource: this.state.dataSource.cloneWithRows(dataBlob, rowId)});
    }
...
class ButtonX extends Component {
    ...
    render() {
        return (
            <TouchableOpacity
                onPress={() =>
                    this.props.clearToSearchParent()}>
            ...
            <View style={styles.irrVerb}>
                <View style={styles.searchInputWithX}>
                    <View style={styles.rowSearch_X}>
                        ...
                        />
                        <ButtonX
                            clearToSearchParent={this.clearToSearch}
                        />
                    </View>
                </View>
